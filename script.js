...
function calculateFare() {
  ...
  if (car === "") {
    fareText.innerText = "Please select car.";
    return;
  }
  ...
  fareText.innerText = `Estimated Fare: ₹${totalFare} (₹${ratePerKm}/km)`;
}
...
document.getElementById("km").addEventListener("input", calculateFare);
document.getElementById("car").addEventListener("change", calculateFare);
